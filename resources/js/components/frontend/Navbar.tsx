    ...
    return (
        <nav className="bg-slate-800 text-white text-xs font-medium border-b border-slate-700">
            <div className="max-w-7xl mx-auto px-4 flex items-center space-x-6 h-10 overflow-x-auto">
                ...
                <Link href="/services" className="hover:text-sky-300 transition whitespace-nowrap">Services</Link>
                <Link href="/notices" className="hover:text-sky-300 transition whitespace-nowrap">Notices</Link>
